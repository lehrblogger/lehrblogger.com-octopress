...
#
# https://github.com/gummesson/jekyll-wordcount, by Ellen Gummesson, MIT License
#
...
module Jekyll
  module WordCount
    def count_words(input)
      calculate(input).to_s.gsub(/(\d)(?=(\d{3})+$)/,'\1,')
      # commify regex from http://stackoverflow.com/a/3697528/551814
    end
