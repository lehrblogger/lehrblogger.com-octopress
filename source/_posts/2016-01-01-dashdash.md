...
[^6]: There are many, many popular apps and services not mentioned here, but they all fall toward one extreme or the other. Part of the reason the market for messaging apps is so crowded is precisely *because* the product design problems are unsolved. Fortunately for Dashdash, contact lists are portable and users are happy to re-add their friends somewhere new.
